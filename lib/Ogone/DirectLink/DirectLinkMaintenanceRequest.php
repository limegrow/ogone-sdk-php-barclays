...
class DirectLinkMaintenanceRequest extends AbstractDirectLinkRequest
{
    ...
    const TEST = "https://mdepayments.epdq.co.uk/ncol/test/maintenancedirect_utf8.asp";
    const PRODUCTION = "https://payments.epdq.co.uk/ncol/prod/maintenancedirect_utf8.asp";
